...
If Test1() And Test2() And Test3() And Test4() And Test5() Then $i = 1 ;MsgBox(0, "Json UDF Test", "All Passed !")

Func Test1()
	Local $Json1 = FileRead(@ScriptDir & "\test.json")
	Local $Data1 = Json_Decode($Json1)
	Local $Json2 = Json_Encode($Data1)
	Local $ttt = Json_IsObject($Json2)
	ConsoleWrite('@@ Debug(' & @ScriptLineNumber & ') : $ttt = ' & $ttt & @CRLF & '>Error code: ' & @error & @CRLF) ;### Debug Console
